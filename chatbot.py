...
class ChatBot:
    ...
    def chat_with_bot(self, user_input):
        ...
        if self.character is not None:
            ...
            prompt = f"Instruction: You are a chatting bot, please respond to the following user input base on the provided input information: {user_input} \
                    Input: {context} {history} Output:"
...
def start_chat():
    ...
    model_path = "/data/youjunqi/nlp/qwen3b"
    ...
    character_path = "/data/youjunqi/nlp/Sheldon.jsonl"
    pdf_path = None
    device="cuda"
